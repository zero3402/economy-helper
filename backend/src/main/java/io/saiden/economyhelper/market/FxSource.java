 ...
 * 환율 출처.
 *
 * <p><b>화면에 반드시 밝힌다.</b> 셋이 성격이 다르다 — KIS는 하루 중에도 움직이고,
 * 유럽중앙은행과 한국 정부는 각자 자기 기준으로 하루 한 번 고시한다. 그 <b>고시 둘</b>만
 * 견줘도 값이 갈렸다: 실측에서 같은 날 Frankfurter {@code 1412.17} / 수출입은행 {@code 1,415}다.
 *
